...
const Biografy = Object.create(Book);
Biografy.title = "Загальна Біографія";
Biografy.author = "Біограф";
Biografy.pages = 200;
...
Object.defineProperty(ScienceBook, "getinfo", {
  get: function () {
    return "Про книгу" + thistitle + ":" + this.info;
  },
});
...
console.log("Про книгу Фізика 101 :", ScienceBook.info);

// Виводимо в консоль налаштування властивости info
console.log(
  "налаштування властивости info :",
